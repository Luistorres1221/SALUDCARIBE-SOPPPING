...
@Component({
  ...
  template: `
    <div class="container mx-auto px-4 py-8">
      ...
      <div *ngIf="cartItems.length > 0" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <mat-card class="mb-4" *ngFor="let item of cartItems">
            <mat-card-content class="flex items-center p-4">
              <img *ngIf="item.image" [src]="item.image" [alt]="item.name" class="w-16 h-16 object-cover mr-4">
              <div class="flex-1">
